# 👋 Hi, I’m Abhishek Jaswal  

**Full-Stack Developer (3+ yrs) | Remote-Ready | AI + Web Systems**  
...
**Database & Infra**  
PostgreSQL · Hasura · Docker · Vercel · Railway  

**Currently Learning**  
Rust (backend performance & systems)

---

## 🚀 Featured Projects

### 🏔️ The North Himalayas  
🔗 https://thenorthhimalayas.com  

Travel & booking platform built with **Next.js + Tailwind CSS**, deployed on **Vercel**.

- Responsive, SEO-optimized pages  
- CRM-style workflows for leads & inquiries  
- Database design for bookings, users, and content  
...
- AI-powered mock interviews using OpenAI API  
- Secure authentication & PostgreSQL data models  
- Scalable backend APIs with Node.js  

---

### 🛒 QuickBasket *(In Progress)*  

Hyperlocal delivery platform using **Hasura GraphQL + Next.js**.

- Real-time product listings & order tracking  
...
- Experience with dashboards, CRM systems, admin panels  
...
![Abhishek's GitHub Stats](https://github-readme-stats.vercel.app/api?username=Abhishek-jaswal&show_icons=true&theme=radical&count_private=true)
...
Building real-world, scalable, and intelligent systems — one project at a time.
